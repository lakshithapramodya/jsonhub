...
function App() {
  ...
  return (
    <div className="min-w-full min-h-screen flex flex-col">
      ...
      <div className="flex flex-col mx-auto mt-10 w-full md:w-1/2 items-center justify-center">
        <form onSubmit={handleSubmit} className="w-full space-y-2 px-5">
          <h1 className="text-4xl font-semibold">JSON Keeper</h1>
          <p>A simple JSON store for your mobile and web app</p>
          <textarea
