  ...
  return (
    <div className="min-w-full min-h-screen flex flex-col">
      ...
      <form
        ...
        className="flex flex-col m-auto w-full md:w-1/2 items-center justify-center space-y-2"
      >
        <div>
          <h1 className="mr-auto ml-6">JSON Keeper</h1>
          <textarea
            onChange={(e) => setInput(e.target.value)}
            value={input}
            rows={18}
            className="border-2 w-[90%] rounded"
          />
          <button
