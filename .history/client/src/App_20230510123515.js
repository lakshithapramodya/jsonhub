...
function App() {
  ...
  return (
    <div className="min-w-full min-h-screen flex flex-col">
      ...
      <div className="flex flex-col mx-auto mt-8 w-full sm:w-[80%] md:w-[70%] lg:w-[58%] items-center justify-center">
        <form onSubmit={handleSubmit} className="w-full space-y-4 px-5">
          <h1 className="text-4xl font-semibod text-gray-700">JSON Keeper</h1>
          ...
          <textarea
            ...
            value={input}
            rows={17}
            className={`border border-gray-700 w-full rounded p-2 px-4 text-lg font-semibold focus:outline-none`}
          />
          <button
