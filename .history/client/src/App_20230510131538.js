    ...
    <div className="min-w-full min-h-screen flex flex-col">
      <div className="flex flex-col mx-auto mt-6 w-full sm:w-[80%] md:w-[70%] lg:w-[58%] items-center justify-center">
        <form onSubmit={handleSubmit} className="w-full space-y-4 px-5">
          {url && (
            <div className="text-lg text-blue-900 flex w-full bg-blue-100 px-6 py-4 rounded-lg">
              <p className="">Your JSON is hosted at: </p>
              <a className="line-clamp-1" href={`${SERVER_ENDPOINT}/${url}`}>
                {`  ${SERVER_ENDPOINT}/${url}`}
              </a>
            </div>
          )}
